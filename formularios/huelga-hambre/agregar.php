...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errores)) {
        ...
        $sql = "INSERT INTO huelga_hambre 
                (dni_ppl, fecha, id_sector, id_pabellon, peso_kg, talla_m, 
        ...
        if ($stmt) {
            ...
            if ($stmt->execute()) {
                $_SESSION['mensaje_exito'] = "✅ Acta de huelga de hambre guardada correctamente";
...
<head>
    ...
    <title>Agregar Huelga de Hambre</title>
    <style>
