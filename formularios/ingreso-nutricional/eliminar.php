...
$sql = "SELECT inr.*, p.nombre_apellido 
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['confirmar']) && $_POST['confirmar'] === 'si') {
        ...
        $sql_delete = "DELETE FROM ingreso_nutricional WHERE id = ?";
...
<head>
    ...
    <title>Eliminar Ingreso Nutricional</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h2>Eliminar Ingreso Nutricional</h2>
        ...
        <ul>
            ...
            <li><strong>Fecha de ingreso:</strong> <?php echo htmlspecialchars($registro['fecha_ingreso']); ?></li>
