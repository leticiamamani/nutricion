...
// Verificar permisos para atención nutricional usando tu función
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errores)) {
        ...
        $sql = "INSERT INTO atencion_nutricional 
                (dni_ppl, fecha, id_sector, id_pabellon, peso_kg, talla_m, observaciones, 
        ...
        if ($stmt) {
            ...
            if ($stmt->execute()) {
                $_SESSION['mensaje_exito'] = "✅ Acta de atención nutricional guardada correctamente";
...
// Obtener fecha para mostrar en formato del acta (usa la fecha del formulario o la actual)
$fecha_mostrar = !empty($datos['fecha']) ? $datos['fecha'] : date('Y-m-d');
list($anio, $mes, $dia) = explode('-', $fecha_mostrar);
...
<head>
    ...
    <title>ACTA DE ATENCIÓN NUTRICIONAL</title>
    <style>
        body {
        ...
        .field-medium {
            min-width: 100px; /* Más pequeño */
        }
        
        .field-interno {
            min-width: 250px; /* Más pequeño */
        }
        ...
        .imc-inline {
            display: inline-block;
            min-width: 150px; /* Ajustado para que quepa el texto con paréntesis */
            border-bottom: 1px solid #000;
            padding: 2px 5px;
            text-align: center;
            margin: 0 5px;
        ...
        select.inline-field {
            ...
            background: transparent;
            font-family: 'Times New Roman', Times, serif;
            font-size: 11pt; /* Un poco más pequeño */
            padding: 2px 5px;
            margin: 0 5px;
            text-align: center;
        }
...
<body>
    ...
    <div class="page-a4">
        ...
        <form method="POST" action="">
            ...
            <!-- Contenido del acta - ESTRUCTURA IDÉNTICA AL PDF -->
            ...
            <!-- Sección de firmas - IGUAL AL PDF -->
