...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['confirmar']) && $_POST['confirmar'] === 'si') {
        ...
        $sql_delete = "DELETE FROM acta_novedad WHERE id = ?";
...
<head>
    ...
    <title>Eliminar Acta de Novedad</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h2>Eliminar Acta de Novedad</h2>
        ...
        <ul>
            ...
            <li><strong>Hora:</strong> <?php echo htmlspecialchars($registro['hora']); ?></li>
        </ul>
